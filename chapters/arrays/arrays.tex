...
\say{Eu só não entendi a barra invertida e o zero como último elemento do
  array.}
...
No entanto, o segundo aspecto é capcioso uma vez que algumas arquiteturas podem
